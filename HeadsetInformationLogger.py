    ...
    if state == 0:
        ...
        if eventType == 64:  # libEDK.IEE_Event_enum.IEE_EmoStateUpdated
            ...
            if wirelessStrength > 0:
                ...
                print IS_GetContactQuality(eState, 3), ",",
                print IS_GetContactQuality(eState, 7), ",",
                print IS_GetContactQuality(eState, 9), ",",
                print IS_GetContactQuality(eState, 12), ",",
                print IS_GetContactQuality(eState, 16), ",",
                print '\n'
